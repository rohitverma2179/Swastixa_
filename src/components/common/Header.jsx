...
// import swastixa from "../../assets/swastixa.svg";

// export default function Navbar() {
//   const [isOpen, setIsOpen] = useState(false);

//   const menuItems = ["WORK", "AWARDS", "CAREERS", "BLOG", "CONTACT"];

//   // === Sidebar Animation Variants ===
//   const sidebarVariants = {
//     hidden: { x: "100%" },
//     visible: { x: 0, transition: { duration: 0.7, ease: [0.77, 0, 0.175, 1] } },
...
//     <motion.span className="inline-block overflow-hidden" whileHover="hover" initial="initial">
...
//               y: [-5, 5, 0],
//               color: "#999",
//               transition: { duration: 0.4, ease: "easeInOut", delay: i * 0.02 },
//             },
//           }}
...
//   return (
//     <nav className=" top-0 left-0 w-full flex justify-between items-center px-6 py-4 z-50 bg-white shadow-md">
//       {/* ===== Logo ===== */}
//       <Link to="/" onClick={() => setIsOpen(false)} className="flex items-center h-10 space-x-2">
//         <img src={swastixa} alt="Logo" className="w-60 h-20 object-contain" />
//       </Link>

//       {/* ===== Menu Icon (Visible in All Views) ===== */}
//       <button
...
//             {/* Sidebar */}
//             <motion.div
//               className="fixed top-0 right-0 w-[80%] sm:w-[60%] md:w-[40%] h-full bg-black text-white z-50 flex flex-col justify-between p-8"
...
//               <button
//                 onClick={() => setIsOpen(false)}
//                 className="self-end p-2 rounded-full bg-white/10 hover:bg-white/20 transition"
//               >
...
//                     className="text-[24px] font-extrabold tracking-tight cursor-pointer"
//                     onClick={() => setIsOpen(false)}
//                   >
...
export default function Navbar() {
  ...
  const menuItems = ["WORK", "ABOUT", "AWARDS", "CAREERS", "BLOG", "CONTACT"];
