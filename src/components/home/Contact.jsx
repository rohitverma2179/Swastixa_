...
export default function ContactSection() {
  ...
  return (
    ...
    //   style={{
    //     backgroundImage: `url("../../assets/bg_img_video/HomeBg/Bg--Swastixa--contact.png")`,
    //   }}
    // >
    ...
    //     playsInline
    //   ></video> */}
    //   {/* <img src="../../assets/bg_img_video/HomeBg/Bg--Swastixa--contact.png" alt="contact images"
    //     className="absolute top-0 left-0 w-full h-full object-cover z-0"
    //   /> */}
    ...
    //     {/* MAIN CARD */}
    //     <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 md:p-10 flex flex-col md:flex-row gap-10">

    //       {/* LEFT FORM SIDE */}
    //       {/* <form className="w-full md:w-[60%] flex flex-col gap-5">
    ...
    //           className="w-full bg-transparent border-b border-white/40 text-white placeholder-white/70 py-3 focus:outline-none h-24"
    //         ></textarea>

    //         <button className="text-white mt-6 border-b border-white/60 w-fit hover:opacity-75 transition-all">
    //           Submit
    //         </button>
    //       </form> */}
    ...
    //         <button
    //           type="submit"
    //           className="text-white mt-6 border-b border-white/60 w-fit hover:opacity-75 transition-all"
    //         >
    //           Submit
    //         </button>
    //       </form>
    ...
    //         <div >
    //           <h2 className="text-lg font-bold">Swastixa Services LLP </h2>
    //           <p className="opacity-90 "> <span className="font-bold"> Head Office : </span> Plot No. 2-A,</p>
    //           <p className="opacity-90"> Kh. No. 51/1, Third Floor,</p>
    //           <p className="opacity-90"> Jai Vihar, Najafgarh Road,</p>
    //           <p className="opacity-90"> Near Sant Haridas School,</p>
    //           <p className="opacity-90"> Near Delhi - 110043</p>
    //           {/* <p className="opacity-90">Address</p> */}
    //         </div>
    //         <br />
    //         <div  >
    //           <h2 className="text-lg "> Registered Office:</h2>
    //           <p className="opacity-90"> Plot No. J04A,</p>
    //           <p className="opacity-90"> Kh. No. 2/19, 2/21, 22, Street 12,</p>
    //           <p className="opacity-90"> Shiv Ram Park,</p>
    //           <p className="opacity-90">  Nangloi, New Delhi - 110041</p>
    //         </div>
    //       </div>
    //     </div>
    //   </div>
      ...
      <div className="relative z-10 w-[95%] md:w-[85%] lg:w-[80%] max-w-6xl">
        ...
        <div className=" bg-[#843c29]/25  backdrop-blur-md  rounded-2xl p-6 md:p-10 flex flex-col justify-between md:flex-row  gap-10">
          ...
          >
            ...
            {/* <button role="link" class=" text-white mt-6  w-fit transition-all relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:translate-y-1 after:bg-neutral-800 after:opacity-0 after:transition after:duration-150   after:ease-in-out hover:after:translate-y-0 hover:after:opacity-100">Contact Us</button> */}
